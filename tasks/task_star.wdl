...
task rna_align {
    meta {
        ...
        description: 'Broad Institute of MIT and Harvard RNA align: align RNA task'
    }
    ...
    String alignment_log = "${default="rna" prefix}.rna.align.${genome_name}.log"
    ...
    command {
        ...
        $(which STAR) \
            ...
            --outFileNamePrefix out/${default="rna" prefix}.rna.align.${genome_name}. \
        ...
        $(which samtools) sort \
            ...
            -m ${samtools_mem_gb}G \
            -o out/${sorted_bam} \
            out/${default="rna" prefix}.rna.align.${genome_name}.Aligned.out.bam
    ...
    parameter_meta {
        fastq_R1: {
                ...
                example: 'processed.rna.R1.fq.gz'
            }
        genome_index_tar: {
